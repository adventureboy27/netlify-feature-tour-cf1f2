...
const SHEET_URLS: Record<AtlasFrame, Record<AtlasSlot, string>> = {
  masc_slim_short: { head: mascSlimShortHeadUrl, face: mascSlimShortFaceUrl, extra: mascSlimShortExtraUrl, upper: mascSlimShortUpperUrl },
  masc_slim_average: { head: mascSlimAverageHeadUrl, face: mascSlimAverageFaceUrl, extra: mascSlimAverageExtraUrl, upper: mascSlimAverageUpperUrl },
  masc_slim_tall: { head: mascSlimTallHeadUrl, face: mascSlimTallFaceUrl, extra: mascSlimTallExtraUrl, upper: mascSlimTallUpperUrl },
  masc_average_short: { head: mascAverageShortHeadUrl, face: mascAverageShortFaceUrl, extra: mascAverageShortExtraUrl, upper: mascAverageShortUpperUrl },
  masc_average_average: { head: mascAverageAverageHeadUrl, face: mascAverageAverageFaceUrl, extra: mascAverageAverageExtraUrl, upper: mascAverageAverageUpperUrl },
  masc_average_tall: { head: mascAverageTallHeadUrl, face: mascAverageTallFaceUrl, extra: mascAverageTallExtraUrl, upper: mascAverageTallUpperUrl },
  masc_heavy_short: { head: mascHeavyShortHeadUrl, face: mascHeavyShortFaceUrl, extra: mascHeavyShortExtraUrl, upper: mascHeavyShortUpperUrl },
  masc_heavy_average: { head: mascHeavyAverageHeadUrl, face: mascHeavyAverageFaceUrl, extra: mascHeavyAverageExtraUrl, upper: mascHeavyAverageUpperUrl },
  masc_heavy_tall: { head: mascHeavyTallHeadUrl, face: mascHeavyTallFaceUrl, extra: mascHeavyTallExtraUrl, upper: mascHeavyTallUpperUrl },
  fem_slim_short: { head: femSlimShortHeadUrl, face: femSlimShortFaceUrl, extra: femSlimShortExtraUrl, upper: femSlimShortUpperUrl },
  fem_slim_average: { head: femSlimAverageHeadUrl, face: femSlimAverageFaceUrl, extra: femSlimAverageExtraUrl, upper: femSlimAverageUpperUrl },
  fem_slim_tall: { head: femSlimTallHeadUrl, face: femSlimTallFaceUrl, extra: femSlimTallExtraUrl, upper: femSlimTallUpperUrl },
  fem_average_short: { head: femAverageShortHeadUrl, face: femAverageShortFaceUrl, extra: femAverageShortExtraUrl, upper: femAverageShortUpperUrl },
  fem_average_average: { head: femAverageAverageHeadUrl, face: femAverageAverageFaceUrl, extra: femAverageAverageExtraUrl, upper: femAverageAverageUpperUrl },
  fem_average_tall: { head: femAverageTallHeadUrl, face: femAverageTallFaceUrl, extra: femAverageTallExtraUrl, upper: femAverageTallUpperUrl },
  fem_heavy_short: { head: femHeavyShortHeadUrl, face: femHeavyShortFaceUrl, extra: femHeavyShortExtraUrl, upper: femHeavyShortUpperUrl },
  fem_heavy_average: { head: femHeavyAverageHeadUrl, face: femHeavyAverageFaceUrl, extra: femHeavyAverageExtraUrl, upper: femHeavyAverageUpperUrl },
  fem_heavy_tall: { head: femHeavyTallHeadUrl, face: femHeavyTallFaceUrl, extra: femHeavyTallExtraUrl, upper: femHeavyTallUpperUrl },
};
