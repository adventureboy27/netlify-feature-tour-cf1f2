// One wrestler, on their own screen.
//
// Everything a booker could know about one person used to live crammed onto
// a roster card — portrait, stats, contract, relationships, discipline,
// career ledger, and four consequential buttons, all at once, on a card the
// size of a phone's palm. Tapping a name anywhere in the game now lands
// here instead, and the roster card that used to hold all of this collapses
// down to the same scannable row every other list of wrestlers already uses
// (see `WrestlerRow`). Tag partners and a manager are shown as real,
// tappable links to their own copy of this same screen — the case that
// exercises the navigation stack's stack-derived remount key (see
// `App.tsx`).
  ...
  return (
    <div className="p-3 pb-24 text-neutral-100">
      ...
      {/* Tag partner(s) and manager — real, tappable relationships, not
          inert text. Tapping one lands on their own copy of this screen. */}
      {partners.length > 0 && (
        <div className="mb-3">
