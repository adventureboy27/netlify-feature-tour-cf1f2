...
import { draftSupershow, runSupershow } from '../engine/world/supershowRun';
 ...
 */
function settleSupershow(world: World, rng: Rng): void {
...
function supershowRoster(world: World, ids: readonly Id[]): Wrestler[] {
  return ids
