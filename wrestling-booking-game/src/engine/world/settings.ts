...
export function defaultWorldSettings(): WorldSettings {
  return {
    ...
    propFailureThreshold: 15,
    propRepairCostFraction: 0.5,
    propBreakChanceAtWorst: 0.35,
    equipmentFailureWeightScale: 45,
    gearUnitsSpectacleBonusPerExtra: 1.5,
    gearUnitsSpectacleBonusCurve: 0.7,
