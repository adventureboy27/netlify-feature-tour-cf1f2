...
export const VENUES: Venue[] = [
  ...
  },
  {
    ...
    prestige: 4,
    minCompanyRating: 0,
    blurb: 'Concrete floor, roll-up doors, and a draught off the loading bay.',
    houseCut: 0,
  ...
  },
  {
    ...
    prestige: 11,
    minCompanyRating: 10,
    blurb: 'They have run meetings here for sixty years. They know how to fill a room.',
    houseCut: 0,
  ...
  // ---------------------------------------------------------------- territory days
  {
    ...
    prestige: 13,
    minCompanyRating: 18,
    blurb: 'Close enough to the ring to hear the boots. Nobody has a bad seat.',
    houseCut: 0,
  ...
  },
  {
    ...
    prestige: 18,
    minCompanyRating: 24,
    blurb: 'A disco ball, a snack counter, and a floor that has seen worse.',
    houseCut: 0.04,
  ...
  },
  {
    ...
    prestige: 15,
    minCompanyRating: 20,
    blurb: 'Grandstand seating for the price of a hall. Bring a tarpaulin.',
    houseCut: 0,
  ...
  // ---------------------------------------------------------------- going somewhere
  {
    ...
    prestige: 21,
    minCompanyRating: 30,
    blurb: 'Municipal, strip-lit, and available every week of the year.',
    houseCut: 0.03,
  ...
  },
  {
    ...
    prestige: 26,
    minCompanyRating: 32,
    blurb: 'Chandeliers, a catering contract older than your promotion, and valet parking.',
    houseCut: 0.08,
  ...
  },
  {
    ...
    prestige: 29,
    minCompanyRating: 38,
    blurb: 'They board over the ice for you. It stays cold anyway.',
    houseCut: 0.06,
  ...
  },
  {
    ...
    prestige: 41,
    minCompanyRating: 46,
    blurb: 'They want the room full and they want every dollar spent in it.',
  ...
  },
  {
    ...
    prestige: 37,
    minCompanyRating: 48,
    blurb: 'A student body with nothing on and a bus route to the door.',
    houseCut: 0.05,
  ...
  },
  {
    ...
    prestige: 33,
    minCompanyRating: 47,
    blurb: 'Ring on the infield, seats on three sides, and a summer to get it right.',
    houseCut: 0.07,
  ...
  },
  {
    ...
    prestige: 44,
    minCompanyRating: 52,
    blurb: 'Built for bands, and every seat points at the same place.',
    houseCut: 0.09,
    concessionsPerHead: 2.6,
    merchCut: 0.12,
  ...
  // ---------------------------------------------------------------- the buildings
  {
    ...
    prestige: 46,
    minCompanyRating: 55,
    blurb: 'Eighty thousand square feet of nothing, and you can have all of it.',
    houseCut: 0.05,
  ...
  },
  {
    ...
    prestige: 63,
    minCompanyRating: 66,
    blurb: 'A tenant team, a scoreboard the size of a house, and a building that knows the drill.',
    houseCut: 0.11,
  ...
  },
  {
    ...
    prestige: 79,
    minCompanyRating: 76,
    blurb: 'Steep, loud, and built by people who understood what a crowd is for.',
    houseCut: 0.12,
  ...
  },
  {
    ...
    prestige: 92,
    minCompanyRating: 84,
    blurb: 'Three thousand more seats than the dome and sixty thousand less rent. And a sky.',
    houseCut: 0.14,
